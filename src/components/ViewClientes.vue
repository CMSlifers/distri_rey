<template>
                                        ...
                                        <v-toolbar class="crud-title" flat>
                                            ...
                                            <v-dialog v-model="dialog" max-width="500px">
                                                <template v-slot:activator="{ props }">
                                                    ...
                                                    <v-btn @click="llamarContador" color="white" dark class="mb-2"
                                                        v-bind="props">
                                                        Nuevo Cliente
                                                    </v-btn>
                                                </template>
                                                            ...
                                                            <v-container>
                                                                <v-row>
                                                                    ...
                                                                    <v-col cols="12" sm="6" md="6">
                                                                        <v-text-field required :rules="dniRules"
                                                                ...
                                                                <v-row>
                                                                    ...
                                                                    <v-col cols="12" sm="6" md="8">
                                                                        <v-combobox
                                                                            ...
                                                                            requiered return-object
                                                                            auto-select-first="exact"
                                                                            v-model="editedItem.departamento" clearable
                                                                            label="Departamento" :items="colombiaJS"
                                                                            item-title="departamento">
                                                                        </v-combobox>
                                                                    </v-col>
                                                                    <v-col v-if="this.editedItem.departamento"
                                                                        @click="agregarDepartamentos" id="combobox-ciudades"
                                                                        cols="12" sm="6" md="8">
                                                                        <v-combobox auto-select-first="exact" return-object
                                                                            clearable label="Ciudad" :items="itemsCiudades"
                                                                            item-title="ciudad" v-model="editedItem.ciudad">
                                                                        </v-combobox>
                                                                    </v-col>
                                                                    ...
                                                                    <v-col cols="12" sm="6" md="4">
                                                                        <v-combobox
                                                                            ...
                                                                            requiered return-object
                                                                            auto-select-first="exact"
                                                                            v-model="editedItem.via" label="Tipo de Vía"
                                                                    ...
                                                                    <v-col cols="12" sm="6" md="4">
                                                                        <v-text-field v-model="editedItem.vianum2"
                                                                            label="#"></v-text-field>
                                                                    </v-col>
                                                                    <v-col cols="12" sm="6" md="4">
                                                                        <v-text-field v-model="editedItem.vianum3"
                                                                            label="-"></v-text-field>
                                                                    </v-col>
 ...
 -->
                                                    ...
                                                    <v-card-actions>
                                                        ...
                                                        <v-btn :disabled="!valid" @click="validate" color="blue-darken-1"
                                                            variant="text">
                                            ...
                                            <v-dialog v-model="dialogDelete" max-width="500px">
                                                <v-card>
                                                    <v-card-title class="text-h6">¿Está seguro que desea eliminar este
