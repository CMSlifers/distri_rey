  ...
  methods: {
    ...
    async llamarCategoria() {
      ...
      datosCate.forEach((doc) => {
        ...
        console.log("id", doc.id, "categoria", doc.categoria);
    ...
    async crearRegistros() {
      ...
      console.log(this.editedItem.name, this.editedItem.id, this.editedItem.usuario, this.editedItem.nombre, this.editedItem.password,this.editedItem.catego)
